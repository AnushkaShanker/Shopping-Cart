...
public class OrderDAO {
    ...
    public void addOrder(Order order) {
        String query = "INSERT INTO Orders (userId, orderDate, totalAmount, paymentStatus, orderStatus, shippingAddress) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            if (rowsAffected > 0) {
                ...
                if (keys.next()) {
                    order.setOrderId(keys.getInt(1)); // Set generated ID
                }
            }
            ...
            try {
                switch (choice) {
                    case 1:
                        ...
                        System.out.println("Order added with ID: " + newOrder.getOrderId());
                        break;
