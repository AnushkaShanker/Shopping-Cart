...
public class PaymentDAO {
    ...
    public void addPayment(Payment payment) {
        String query = "INSERT INTO Payment (orderId, amount, paymentStatus) VALUES (?, ?, ?)";
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            if (rowsAffected > 0) {
                ...
                if (keys.next()) {
                    payment.setPaymentId(keys.getInt(1)); // set the generated ID
                }
            }
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    System.out.println("Payment added with ID: " + newPayment.getPaymentId());
                    break;
