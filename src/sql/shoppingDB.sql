...
ALTER TABLE admin MODIFY adminId INT NOT NULL AUTO_INCREMENT;
ALTER TABLE cartitem MODIFY cartItemId INT NOT NULL AUTO_INCREMENT;
...
ALTER TABLE shipment MODIFY shipmentId INT NOT NULL AUTO_INCREMENT;
ALTER TABLE user MODIFY userId INT NOT NULL AUTO_INCREMENT;
-- Dump completed on 2025-06-24 16:56:53
